...
\end{align}
Rogers et al. argue that the conditional probabilities of formula assignments should be predicated on current assignments, and how pairs of molecules can be related by biotransformations. They present the following form for the conditional probability (we have rewritten using our notation):
\begin{align}
p( I(m_i=\ell_j )=1|\mathbfcal{I},\delta) =  \frac{\beta_{ji}+\delta}{C\delta+\sum_{j'i}}
\end{align}
where:
\begin{align}
